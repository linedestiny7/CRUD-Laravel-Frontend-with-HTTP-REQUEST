  ...
  <body>
    ...
    <form>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="sub_judul_berita" class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label">Short Desc Berita</label>
            <input type="text" name="Short_desc_berita" class="form-control">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="lokasi_berita" class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label">Jumlah Berita Dibaca</label>
            <input type="number" name="jumlah_berita_dibaca" class="form-control">
          </div>
